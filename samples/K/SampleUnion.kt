...
data class SampleUnion @KotlinOnly constructor(
  ...
  fun isOption1() = type == SampleUnionUnionType.OPTION1

  fun isOption2() = type == SampleUnionUnionType.OPTION2

  fun isOption3() = type == SampleUnionUnionType.OPTION3

  /**
   * Initializes a builder to the same property values as as this existing instance's values.
   */
  @JavaOnly
  internal fun toBuilder() =
      Builder(type = this.type, option1 = this.option1, option2 = this.option2, option3 = this.option3)

  override fun toString() = _toString

  fun isUnknown() = type == SampleUnionUnionType.UNKNOWN
  ...
  class Builder internal constructor(
    ...
    fun type(type: SampleUnionUnionType) = apply {
      this.type = type
    }

    fun option1(option1: String?) = apply {
      this.option1 = option1
    }

    fun option2(option2: Boolean?) = apply {
      this.option2 = option2
    }

    fun option3(option3: Int?) = apply {
  ...
  companion object {
    ...
    @JvmStatic
    fun createOption1(option1: String?) = SampleUnion(type = SampleUnionUnionType.OPTION1, option1 =
        option1)

    @JvmStatic
    fun createOption2(option2: Boolean?) = SampleUnion(type = SampleUnionUnionType.OPTION2, option2
        = option2)

    @JvmStatic
    fun createOption3(option3: Int?) = SampleUnion(type = SampleUnionUnionType.OPTION3, option3 =
        option3)
