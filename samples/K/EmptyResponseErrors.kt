...
class EmptyResponseErrors private constructor(
  ...
  companion object {
    ...
    @JvmStatic
    fun unknown() = EmptyResponseErrors(UNKNOWN_CODE)

    @JvmStatic
    fun ofBadRequest(value: BadRequest) = EmptyResponseErrors(_code = "BAD_REQUEST", badRequest =
        value)

    @JvmStatic
    fun ofUnauthenticated(value: Unauthenticated) = EmptyResponseErrors(_code = "UNAUTHENTICATED",
        unauthenticated = value)

    @JvmStatic
    fun ofServerError(value: ServerError) = EmptyResponseErrors(_code = "SERVER_ERROR", serverError
        = value)

    @JvmStatic
    fun ofRateLimited(value: RateLimited) = EmptyResponseErrors(_code = "RATE_LIMITED", rateLimited
        = value)

    @JvmStatic
    fun ofNoContent() = EmptyResponseErrors(_code = "", noContent = NoContent)
