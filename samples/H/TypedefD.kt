...
data class TypedefD @KotlinOnly constructor(private val value: Long) : TypeSafeLong {
  ...
  companion object {
     ...
     */
    @JvmStatic
    fun wrapFrom(other: TypeSafeLong): TypedefD = wrap(other.get())

    @JvmStatic
    fun wrap(value: Long): TypedefD = TypedefD(value)
  }
}
