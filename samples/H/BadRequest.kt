...
data class BadRequest @KotlinOnly constructor(
  @Property @get:JvmName("code") val code: BadRequestCode,
  @Property @get:JvmName("message") val message: String,
  @Property @get:JvmName("data") val data: ImmutableMap<String, String>? = null
) {
  /**
   * Initializes a builder to the same property values as as this existing instance's values.
   */
  @JavaOnly
  fun toBuilder(): Builder = Builder(code = this.code, message = this.message, data = this.data)

  @DoNotMock
  @ThriftElement.Builder
  class Builder internal constructor(
    private var code: BadRequestCode? = null,
    private var message: String? = null,
    private var data: Map<String, String>? = null
  ) {
    fun code(code: BadRequestCode): Builder = apply {
      this.code = code
    }
    ...
    fun data(data: Map<String, String>?): Builder = apply {
      this.data = data
    }
  ...
  companion object {
    ...
    fun builderWithDefaults(): Builder = builder()
            .code(BadRequestCode.values()[0])
            .message("Stub")

    @JavaOnly
    @JvmStatic
    @VisibleForTesting(otherwise = 5)
    fun stub(): BadRequest = builderWithDefaults().build()
  }
}
