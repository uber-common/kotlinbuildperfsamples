...
class RateLimitedJsonAdapter(moshi: Moshi) : JsonAdapter<RateLimited>() {
    ...
    private val rateLimitedCodeAdapter: JsonAdapter<RateLimitedCode> =
            moshi.adapter<RateLimitedCode>(RateLimitedCode::class.java, kotlin.collections.emptySet(), "code")
    ...
    override fun fromJson(reader: JsonReader): RateLimited {
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                0 -> code = rateLimitedCodeAdapter.fromJson(reader) ?: throw JsonDataException("Non-null value 'code' was null at ${reader.path}")
