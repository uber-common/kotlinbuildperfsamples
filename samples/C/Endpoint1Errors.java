...
/** Errors for {@link SampleServiceClient#endpoint1} */
@Generated(
...
@Immutable
public class Endpoint1Errors extends Error {
  ...
  public static Endpoint1Errors unknown() {
    return new Endpoint1Errors(UNKNOWN_CODE, null, null, null, null, null);
  }
  ...
  public static Endpoint1Errors ofBadRequest(BadRequest value) {
    return new Endpoint1Errors("BAD_REQUEST", value, null, null, null, null);
  }
  ...
  public static Endpoint1Errors ofUnauthenticated(Unauthenticated value) {
    return new Endpoint1Errors("UNAUTHENTICATED", null, value, null, null, null);
  }
  ...
  public static Endpoint1Errors ofServerError(ServerError value) {
    return new Endpoint1Errors("SERVER_ERROR", null, null, value, null, null);
  }
  ...
  public static Endpoint1Errors ofRateLimited(RateLimited value) {
    return new Endpoint1Errors("RATE_LIMITED", null, null, null, value, null);
  }
  ...
  public static Endpoint1Errors ofNoContent() {
    return new Endpoint1Errors("", null, null, null, null, NoContent.INSTANCE);
  }
  ...
  public static Endpoint1Errors create(ErrorAdapter errorAdapter) throws IOException {
    try {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o instanceof Endpoint1Errors) {
      Endpoint1Errors that = (Endpoint1Errors) o;
  ...
  public String toString() {
    if ($toString == null) {
      ...
      $toString = "Endpoint1Errors(" + _presentField + "=" + _presentFieldValue + ")";
    }
    return $toString;
  }
}
